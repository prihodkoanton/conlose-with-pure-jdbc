...
class StudentsDaoImplTest extends DaoTestBaseClass {
    ...
    void shouldFindAll() throws SQLException {
        ...
        List<Students> expected = Arrays.asList(new Students(1000L, 1000, "one", "one last_name"),
    ...
    void shouldByName() throws SQLException {
        sql("sql/forStudents/find_by_id_students.sql");
        Students expected = new Students(1000L, 1000, "find-me", "in-junit-test");
        Students actual = fromTransaction(datasource, connection -> dao.findByName(connection, "find-me"))
                .orElseThrow();
        assertEquals(actual, expected);
    }
    ...
    void shoudlCreate() throws SQLException {
        Students expected = new Students(0, "new", "student");
