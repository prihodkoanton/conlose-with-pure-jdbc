...
class CourseDaoImplTest extends DaoTestBaseClass {
    ...
    void shouldFindAll() throws SQLException {
        ...
        List<Course> expected = Arrays.asList(new Course(1000L, "one", "one description"),
                new Course(1001L, "two", "two description"), new Course(1002L, "three", "three description"),
                new Course(1003L, "four", "four description"));

        List<Course> actual = fromTransaction(datasource, connection -> dao.findAll(connection));
    ...
    void shouldDeleteById() throws SQLException {
        sql("sql/forCourse/find_by_id_courses.sql");
        Connection connection = DriverManager.getConnection("jdbc:postgresql://localhost:7432/antonprihodko", "anton",
                "1234");
